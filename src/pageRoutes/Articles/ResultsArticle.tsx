...
export const ResultsArticle = () => {
  return (
    <>
      ...
      <p>The results table lists all drugs or chemicals that may impact the disease you specified in your search. Each row contains the result's name, a check mark indicating its FDA approval status, and the amount of evidence that led to its inclusion in the list of responses.</p>
      ...
      <p>Below each result name, you will see the number of paths through which the drug may impact your specified disease. Paths are interactive graphs that connect potential therapeutics to the disease that they may impact. Some paths contain only the result, the disease, and the relationship(s) between the two. Other paths can be more complicated, such as a path showing how the result, the disease, another chemical, and a protein may interact.</p>
      ...
      <p><strong>Please note that an “Approved” status does not mean that the FDA has approved these drugs to impact the disease(s) you specified in your search, but rather that they have been approved to treat a specific disease or condition.</strong></p>
    </>
  );
}

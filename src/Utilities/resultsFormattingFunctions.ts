 ...
 */
// const calculateEvidenceCounts = (paths: Path[]): EvidenceCountsContainer => {
//   const addPubsAndCTsToSets = (edge: ResultEdge, pubSet: Set<string>, ctSet: Set<string>, miscSet: Set<string>) => {
...
//     }
//   }
//   const addSourcesToSet = (edge: ResultEdge, sourceSet: Set<string>) => {
//     if(!!edge.provenance) {

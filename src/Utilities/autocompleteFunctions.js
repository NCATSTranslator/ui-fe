...
const newFetchNodesFromInputText = async (inputText, type, prefixes) => {
  ...
  return fetch(`http://name-resolution-sri-dev.apps.renci.org/lookup?string=${inputText}&offset=0&limit=40&biolink_type=${type}${prefixString}`, nameResolverRequestOptions)
}

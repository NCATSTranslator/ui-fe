...
import { EvidenceSortState, PublicationObject, RawPublicationList, TrialObject } from '@/features/Evidence/types/evidence';
import { ResultEdge, ResultSet } from '@/features/ResultList/types/results';
import { getPubById, getTrialById } from '@/features/ResultList/slices/resultsSlice';

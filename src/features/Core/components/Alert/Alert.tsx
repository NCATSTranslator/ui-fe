import { useState, useEffect, useCallback, useMemo, ReactNode, FC, KeyboardEvent, SVGProps } from "react";
...
const ALERT_ICONS: Record<AlertType, FC<SVGProps<SVGSVGElement>>> = {
  success: Checkmark,
  warning: Warning,
  error: Cross,
  info: Info,

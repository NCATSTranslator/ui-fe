...
import { getMoreInfoLink, getNodeIcon } from '@/features/Core/utils/entityLinks';
...
import AutocompleteDisclaimer from '@/features/Core/components/AutocompleteDisclaimer/AutocompleteDisclaimer';
...
const Autocomplete: FC<AutocompleteProps> = ({
  ...
  useEffect(() => {
    handleScrolling(scrollingIndex);

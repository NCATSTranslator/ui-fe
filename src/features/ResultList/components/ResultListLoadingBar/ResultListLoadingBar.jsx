...
const ResultListLoadingBar = ({ data, totalIntervals = 6 }) => {
  ...
  return(
    <>
      <div 
        className={`${styles.ResultListLoadingBar}`}
        >
          <div className={styles.top}>
            <ResultListLoadingButton data={data} currentPercentage={barWidthPercentage}/>
          </div>

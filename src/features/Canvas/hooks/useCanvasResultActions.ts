...
import { extractNodesAndEdgesFromResult, extractNodesAndEdgesFromPath, extractNodesAndEdgesFromAllResults, extractNodeFromResultSet, resultEdgeToCanvasEdge } from '@/features/Canvas/utils/canvasGraphFunctions';
...
const useCanvasResultActions = (
  ...
  const addEdgeFromEvidence = useCallback((resultSet: ResultSet, edgeId: string) => {
    ...
    mergeEntities(nodes, [resultEdgeToCanvasEdge(edge)], submission);

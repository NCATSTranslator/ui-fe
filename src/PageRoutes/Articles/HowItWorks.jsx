export const HowItWorks = () => {
  return (
    <>
      ...
      <p style={{textAlign: 'center'}}><img src="https://lh5.googleusercontent.com/iSfNjM2IonMBeXzyo4z6kxehnQ_MpZIJbOVQLmJ84KddHkGyoFGvmGp5s3axwOq0mpw=w2400" alt="Translator Architecture" width="50%" /></p>
    </>
  );
}

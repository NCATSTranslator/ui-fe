...
export const ExploringRelationships = () => {
  ...
  return (
    <>
      ...
      <p style={{textAlign: 'center'}}><img src={selectRelImage} alt="select a relationship you'd like to explore example" /></p>
      ...
      <p style={{textAlign: 'center'}}><img src={searchTermImage} alt="submitting a search term example" /></p>
      ...
      <p style={{textAlign: 'center'}}><img src={returnedImage} alt="example showing results" /></p>
    </>
  );
}

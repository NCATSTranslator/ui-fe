...
export const SendFeedbackArticle = () => {
  ...
  return (
    <>
      <p className="caption">Last updated on September 30th, 2024</p>
      <p>To send feedback to the Translator team, please fill out <Link className="link" to={`/send-feedback`} reloadDocument target={'_blank'}>this form</Link>. There are several categories of feedback that you can submit:</p>

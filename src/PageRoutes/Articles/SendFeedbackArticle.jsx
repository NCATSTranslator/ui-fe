...
export const SendFeedbackArticle = () => {
  ...
  return (
    <>
      ...
      <p>To send feedback to the Translator team, please fill out <Link className="link" to={`${getGeneratedSendFeedbackLink(true)}`} reloadDocument target={'_blank'}>this form</Link>. There are several categories of feedback that you can submit:</p>

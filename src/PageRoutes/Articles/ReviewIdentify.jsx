...
export const ReviewIdentify = () => {
  ...
  return (
    <>
      ...
      <p style={{'text-align': 'center'}}><img src={reviewImage} alt="example showing the paths from a result" /></p>
      ...
      <p style={{'text-align': 'center'}}><img src={filterImage} style={{'width' : '300px'}} alt="results page with filter bar on left" /></p>

...
export const Help = () => {
  ...
  return (
    <>
      ...
      <h2 className="h6">How can I share my results?</h2>
      <p>Click on the purple export icon to the top right of a result list to generate a shareable link. This link can also be generated by clicking the same icon next to a result set in <Link to={`/${root}/history`}>search history</Link>.</p>

...
import shareResultImage from '../../Assets/Images/shareResult.png';
...
export const Help = () => {
  ...
  return (
    <>
      ...
      <h2 className="h6">How can I share my results?</h2>
      <p>Click on the "Share Result Set" button at the top of the result list to generate a shareable link. This link can also be generated by clicking the same icon next to a result set in <Link to={`/history`}>search history</Link>.</p>
      <p style={{textAlign: 'center'}}><img src={shareImage} style={{maxWidth: '600px'}} alt="example screenshot showing share button on results page" /></p>
      <p>Additionally you can generate a link to a specific result by clicking the share button on an that result.</p>
      <p style={{textAlign: 'center'}}><img src={shareResultImage} alt="example screenshot showing share button on individual result" /></p>

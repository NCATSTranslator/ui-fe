...
const About = () => {
  return (
    <div className={`container`}>
      ...
      <p>Listen to former NCATS Director Christopher P. Austin, M.D., <strong>explain the purpose and goals of the Biomedical Data Translator program.</strong> </p>

      <p>To realize the vision of the Biomedical Data Translator and transition from the feasibility assessment phase to a working platform that serves as a resource to the translational research community, NCATS is funding new teams of scientists, physicians, bioinformaticists and programmers to begin the development phase of the Translator. In fiscal year 2020, NCATS awarded approximately $13.5 million to establish the initial Biomedical Data Translator Consortium.</p>

      <p>The platform the Consortium members create, funded through NCATS's Other Transactions Authority, will be designed to —</p>
